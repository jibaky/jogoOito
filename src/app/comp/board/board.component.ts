...
export class BoardComponent implements OnInit {
  ...
  ngAfterViewInit():void{
    this.tileList = [this.piece0,this.piece1,this.piece2,this.piece3,this.piece4,this.piece5,this.piece6,this.piece7,this.piece8]
  ...
  updateTiles(board: string[][]):void{
    ...
    for(let i=0; i<board.length; i++){
      for(let j=0; j<board[i].length; j++){
        ...
        if(currentPiece == 0) this.tileList[currentPiece].nativeElement.style.visibility = "hidden";
